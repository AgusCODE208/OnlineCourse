...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:student')->group(function () {
        ...
        Route::middleware(['check.subscription'])->group(function () {
            ...
            Route::get('/dashboard/learning/{course:slug}/finished', [CourseController::class, 'learning_finished'])->name('dashboard.learning.course.finished');
        });

        Route::get('checkout/success', [FrontController::class, 'checkout_success'])->name('front.checkout.success');
        Route::post('checkout/{pricing}', [FrontController::class, 'checkout'])->name('front.checkout');
