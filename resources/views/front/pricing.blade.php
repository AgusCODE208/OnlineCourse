...
@section('title','Pricing - Agus Kurnia')
@section('content')
<x-nav-guest/>
        <main class="flex flex-col flex-1 justify-center">
            <section id="pricing" class="flex flex-col items-center gap-[33px] mt-[50px]">
                ...
                <div class="flex items-center gap-5">
                    ...
                    @foreach ($pricing_package as $package)
                    <div class="price-card-popular flex flex-col h-fit w-full max-w-[314px] shrink-0 rounded-[20px] border-2 border-obito-green gap-5 bg-white overflow-hidden">
                        ...
                        <div class="flex flex-col gap-5 p-5 pt-0">
                            ...
                            <div class="price">
                                ...
                                <p class="mt-[6px] text-obito-text-secondary">{{ $package->duration }} moths duration</p>
                            </div>
                            <hr class="border-obito-grey">
                            <div class="flex flex-col gap-4">
                                <p class="flex items-center gap-2">
                            ...
                            <form action="#" method="post">
                                @csrf
                                <button type="submit">You Subscribed</button>
                            </form>
                            ...
                            @else
                            <form action="{{ route('front.checkout', $package) }}" method="post">
                                @csrf
                                <button type="submit">Get Pro</button>
                            </form>
                                {{-- <a type href="{{ route('front.checkout', $package) }}" class="w-full h-11 rounded-full py-[10px] px-5 gap-[10px] bg-obito-green text-center hover:drop-shadow-effect transition-all duration-300">
